...
class Words:
    ...
    def find_words(self):                   #function to find and compare files
        string1 = self.load_file("../pythonProject/herbert1.txt", "r")   #calls function to open file in read mode
        string2 = self.load_file("../pythonProject/herbert2.txt", "r")
        stops = self.load_file("../pythonProject/stops.txt", "r")
        try:
